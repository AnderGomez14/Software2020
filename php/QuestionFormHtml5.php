			...
			<form id='fquestion' name='fquestion' action='AddQuestion.php'>
				<table style="margin: 0px auto">
					<tr>
						...
						<td><input type="text" id="mail" name="mail" pattern="([a-zA-Z]+[0-9]{3}(@ikasle.ehu.)((eus)|(es)))|([a-zA-Z]+[0-9]{3}(@ikasle.ehu.)((eus)|(es)))|([a-zA-Z]+(@ehu.)((eus)|(es)))" required></td>
					</tr>
					<tr>
						<td align="left"><label id='lenunciado'>Enunciado de la pregunta:* </label></td>
						<td><input type="text" id="enum" name="enum" minlength="10" required></td>
					</tr>
					<tr>
						<td align="left"><label id='lcorrecta'>Respuesta correcta*: </label></td>
						<td><input type="text" id="correcta" name="correcta" required></td>
					</tr>
					<tr>
						<td align="left"><label id='linco1'>Respuesta incorrecta 1*: </label></td>
						<td><input type="text" id="inco1" name="inco1" required><br></td>
					</tr>
					<tr>
						<td align="left"><label id='linco2'>Respuesta incorrecta 2*: </label></td>
						<td><input type="text" id="inco2" name="inco2" required></td>
					</tr>
					<tr>
						<td align="left"><label id='linco3'>Respuesta incorrecta 3*: </label></td>
						<td><input type="text" id="inco3" name="inco3" required></td>
					</tr>
					<tr>
						<td align="left"><label id='lcomplejidad'>Complejidad*: </label></td>
						<td> <select id="complejidad" name="complejidad" required>
					...
					<tr>
						...
						<td><input type="text" id="tema" name="tema" required></td>
					</tr>
				</table><br><br>
